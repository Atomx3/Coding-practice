# this script is specifically used to translate the named entities in the text files from Chinese to other languages.
...
def is_already_translated(file_path, target_lang):
    ...
    try:
        ...
        if valid_chars > 0 and target_chars / valid_chars > 0.8:
