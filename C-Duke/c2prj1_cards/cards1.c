...
#include "cards.h"
//#include "deck.h"
// another solution, more code version.
...
/* another solution for the function card_from_num. 
// Maps a number to a unique card value/suit combination
card_t card_from_num(unsigned c) {
  card_t temp;
  temp.value = c % 13 + 2; // Map number to card value
  temp.suit = c / 13; // Map number to card suit
